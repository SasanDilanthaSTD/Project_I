        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active itemnew" href="#"><strong>About Us</strong></a></li>
...
<div class="d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center highlight-blue"
     id="About"
     style="height: 500px;background: url(&quot;../assets/use_image/aboutusbackground.jpg&quot;), rgba(0,0,0,0);background-size: cover, auto;">
    <div class="container"><!-- Start: Intro -->
        <div class="intro"><h2 class="text-center"
            ...
            <div style="text-align: center;"><img src="../assets/use_image/Untitled-1.png" style="width: 273px;"></div>
        </div><!-- End: Intro --></div>
    ...
    <footer class="text-center" style="background: rgb(255,255,255);">
        <div class="container text-muted py-4 py-lg-5">
            <ul class="list-inline" style="margin-top: -25px;">
                ...
                <li class="list-inline-item me-4"><a class="link-secondary" href="#"><br><span
                            style="color: RGBA(86,94,100,var(--bs-link-opacity,1)) ;">+94 76 890 4453</span></a></li>
            </ul>
