...
<div class="row" style=" margin-right: 0px;margin-left: 0px;">
    <div class="col-md-8" style="padding: 30px; padding-left: 70px; padding-right: 70px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row pt-1">
                            <div class="col-6 mb-3">
                                <h6>First Name</h6>
                                <p class="text-muted"><?php echo $item->firstname; ?></p>
                            </div>
                            <div class="col-6 mb-3">
                                <h6>Last Name</h6>
                                <p class="text-muted"><?php echo $item->lastname; ?></p>
                            </div>
                            <div class="col-6 mb-3">
                                <h6>User Name</h6>
                                <p class="text-muted"><?php echo $item->username; ?></p>
                            </div>
                            <div class="col-6 mb-3">
                                <h6>Email</h6>
                                <p class="text-muted"><?php echo $item->email; ?></p>
                            </div>
                            <a href="profedit.php" style="text-decoration: none">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary loginbtn" type="button" style="border: none">
                                        Edit Profile
                                    </button>
                                </div>
                            </a>
        ...
        <div class="d-grid gap-2" >
            <button class="btn btn-primary doctrbtn" type="button">Check Your Stress Level</button>
            ...
            <div class="container-fluid main">
                <div class="text-center main-text">
                    ...
                    <div class="c2a-btn footer-c2a-btn">
                        <h3 style="color: #00738b; font-weight: bold;padding-bottom: 0px" >Contact Doctor</h3>
                        ...
                        <div class="btn-group btn-group-lg" role="group" aria-label="Call to action">
                            <a type="button" class="btn btn-default btn-lg" href="#" style="font-weight: bold">MHS Chat</a>
                            <span class="btn-circle btn-or">or</span>
                            <a type="button" class="btn btn-default btn-lg" href="#" style="font-weight: bold">Video Chat</a>
                        </div>
                    </div>
                </div>
            </div>
