...
<div><!-- Start: Navbar Right Links -->
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"
                        ...
                        src="../assets/use_image/Untitled-1.png" style="width: 109px;"></a></div>
        ...
        <div class="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 reg" style="border-radius: 9px;background: #ffffffb0;">
            <div class="p-5">
                ...
                <div class="text-center">
                    <h4 class="text-dark mb-4" style="font-size: 31.704px;"><strong><span
                                    style="color: rgb(0, 115, 139);">Create an Account</span></strong></h4>
                ...
                <form class="user" action="../php/Code/signup.php" method="post"><!-- Start: Names -->
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" name="pw"
                                                                  ...
                                                                  required="" style="background: #ababab;"></div>
                        <div class="col-sm-6"><input class="form-control form-control-user" type="password" name="rpw"
                    ...
                    <div style="margin-bottom: 10px;"><!-- Start: 1 Row 3 Columns -->
                        ...
                        <div id="pdf-input" style="display: none;">
                            <label for="pdf-file">Upload Your CV:</label>
                ...
                <div style="text-align: center;"><a class="forgot-password" href="login.php" style="font-size: 14px;text-decoration: none"><span
                                style="color: rgb(0, 0, 0);">Already have an account? <?php ?></span></a>
                </div>
                <div style="text-align: center; color: white; background-color: red; border-radius: 7px; width: 50%; margin-left: 180px; margin-right: 180px">
                    <?php
                    if (isset($_GET["error"])) {
                        if ($_GET["error"] == 1) {
