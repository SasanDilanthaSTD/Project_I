...
<head>
    ...
    <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Stick+No+Bills&amp;display=swap"
    />
    <link
        rel="stylesheet"
...
<div>
    ...
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container">
            ...
            ><img src="../assets/use_image/Untitled-1.png" style="width: 109px"
                /></a>
        </div>
    </nav>
    <!-- End: Navbar Right Links -->
</div>
<!-- End: nav bar --><!-- Start: Profile Edit Form -->
<div
