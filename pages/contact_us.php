...
<div><!-- Start: Navbar Right Links -->
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"
                        ...
                        src="../assets/use_image/logo.png" style="width: 109px;"></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active itemnew" href="#"><strong>Contact Us</strong></a>
                    </li>
                </ul>
                <a class="btn btn-primary ms-md-2 loginbtn" role="button" href="#" style="border-style: none;"><strong>Sign
                        In/Up</strong></a></div>
        </div>
    </nav><!-- End: Navbar Right Links --></div><!-- End: nav bar --><!-- Start: Contact Details -->
<section class="position-relative py-4 py-xl-5"
         style="background: url(&quot;../assets/use_image/paper-airplanes-pointing-brain-with-copy-space.jpg&quot;);background-size: cover;">
                ...
                <div class="d-flex flex-column justify-content-center align-items-start h-100">
                    <div class="d-flex align-items-center p-3">
                        ...
                        <div class="px-2"><h6 class="mb-0"><span style="color: rgb(255, 255, 255);">Phone</span></h6>
                            <p class="mb-0"><span style="color: rgb(255, 255, 255);">+94 76 890 4453</span></p></div>
                    </div>
                    <div class="d-flex align-items-center p-3">
                        <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
