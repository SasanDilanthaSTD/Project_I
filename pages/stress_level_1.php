<!-- Modal -->
<div class="modal fade bg-glass_sub" id="stress_1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content" style="width: auto">
            ...
            <div class="modal-body">
                <div class="mb-4">
                    <p class="fw-normal">In the last month, how often have you been angered because of things that happened that were outside of your control?</p>
                </div>
