...
foreach ($user1 as $item){
    ?>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row pt-1">
                                    <div class="col-6 mb-3">
                                        <h6>First Name</h6>
                                        <p class="text-muted">Isuru</p>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <h6>Last Name</h6>
                                        <p class="text-muted">Dhananjaya</p>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <h6>User Name</h6>
                                        <p class="text-muted">isuru213</p>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <h6>Email</h6>
                                        <p class="text-muted">isuru@gmail.com</p>
                                    </div>
                ...
                <div class="d-grid gap-2">
                    ...
                    <button class="btn btn-primary doctrbtn" type="button">Register Patient</button>
                </div>
                </div>
            </div>
        </div>
