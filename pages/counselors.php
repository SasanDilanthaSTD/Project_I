        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link itemnew" href="#"><strong>Home</strong></a></li>
        ...
        <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
            <div class="col">
                <div class="card h-100 shadow-sm"><img
                            src="../assets/use_image/isuru.png"
                            class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="clearfix mb-3"><span
                                    class="float-start badge posttag">Counselor</span> <span
                                    class="float-end price-hp">Isuru Dhananjaya</span></div>
                        <h5 class="card-title text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                            Veniam
            ...
            <div class="col">
                <div class="card h-100 shadow-sm"><img
                            src="../assets/use_image/senura.png"
                            class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="clearfix mb-3"><span
                                    class="float-start badge posttag">Counselor</span> <span
                                    class="float-end price-hp">Senura Adithya</span></div>
                        <h5 class="card-title text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                            Veniam
                            quidem eaque ut eveniet aut quis rerum. Asperiores accusamus harum ducimus velit odit
                            ut. Saepe, iste optio laudantium sed aliquam sequi.</h5>
            ...
            <div class="col">
                <div class="card h-100 shadow-sm"><img
                            src="../assets/use_image/sasan.png"
                            class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="clearfix mb-3"><span
                                    class="float-start badge posttag">Counselor</span> <span
                                    class="float-end price-hp">Sasan Dilantha</span></div>
                        <h5 class="card-title text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                            Veniam
                            quidem eaque ut eveniet aut quis rerum. Asperiores accusamus harum ducimus velit odit
                            ut. Saepe, iste optio laudantium sed aliquam sequi.</h5>
            ...
            <div class="col">
                <div class="card h-100 shadow-sm"><img
                            src="../assets/use_image/thushari.png"
                            class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="clearfix mb-3"><span
                                    class="float-start badge posttag">Counselor</span> <span
                                    class="float-end price-hp">T. Senevirathne</span></div>
                        <h5 class="card-title text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                            Veniam
                            quidem eaque ut eveniet aut quis rerum. Asperiores accusamus harum ducimus velit odit
                            ut. Saepe, iste optio laudantium sed aliquam sequi.</h5>
