function swipeDetect(e, t) {
    var a, r, n, o, i, s, d = e, c = t || function (e) {
    };
    d.addEventListener("touchstart", (function (e) {
        var t = e.changedTouches[0];
        a = "none", dist = 0, r = t.pageX, n = t.pageY, s = (new Date).getTime()
    }), !1), d.addEventListener("touchmove", (function (e) {
    }), !1), d.addEventListener("touchend", (function (e) {
        var t = e.changedTouches[0];
        o = t.pageX - r, i = t.pageY - n, (new Date).getTime() - s <= 300 && (Math.abs(o) >= 150 && Math.abs(i) <= 100 ? a = o < 0 ? "left" : "right" : Math.abs(i) >= 150 && Math.abs(o) <= 100 && (a = i < 0 ? "up" : "down")), c(a)
    }), !1)
}
...
let isOpen = function (e) {
    ...
    let e = !1;
    return $(".navbar.fixed-top.off-canvas").each((function () {
    ...
    if (!isOpen(e)) {
        if (!anyOpenDrawers()) {
            let t = e.parent();
            (t.hasClass("drawer-push") || t.hasClass("drawer-slide")) && t.addClass("open"), $("body").addClass("drawer-open")
        }
        e.addClass("open").attr("data-open-drawer", "1")
    }
}, closeDrawer = function (e, t) {
    void 0 === t && 0 === (t = $(".navbar.fixed-top.off-canvas.open")).length && (t = $('.navbar.fixed-top.off-canvas[data-open-drawer="1"]'));
    let a = t.parent();
    t.removeClass("open"), t.attr("data-open-drawer", "0"), anyOpenDrawers() || ((a.hasClass("drawer-push") || a.hasClass("drawer-slide")) && a.removeClass("open"), $("body").removeClass("drawer-open"))
}, getRightDrawer = function () {
    let e = $(".navbar.fixed-top.off-canvas.right-drawer");
    return 0 === e.length && (e = $('.navbar.fixed-top.off-canvas[data-right-drawer="1"]')), 0 === e.length && (e = null), e
}, getLeftDrawer = function () {
    let e = $(".navbar.fixed-top.off-canvas:not(.right-drawer)");
    if (0 === e.length) return null;
    let t = null;
    return e.each((function () {
        if (void 0 === e.attr("data-right-drawer") || "0" == e.attr("data-right-drawer")) return t = e, !1
    })), t
}, toggleDrawer = function (e) {
    isOpen(e) ? closeDrawer(e) : openDrawer(e)
};
$(document).on("click touch", '[data-dismiss="drawer"]', {}, closeDrawer), $(document).on("click touch", '[data-dismiss="left-drawer"]', {}, (function (e) {
    ...
    let t = getLeftDrawer(), a = getRightDrawer();
    "left" === e ? t.length > 0 && isOpen(t) ? closeDrawer(t) : a.length > 0 && openDrawer(a) : "right" === e && (a.length > 0 && isOpen(a) ? closeDrawer(a) : t.length > 0 && openDrawer(t))
}));