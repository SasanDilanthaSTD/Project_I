	...
	<div><!-- Start: Navbar Right Links -->
		<nav class="navbar navbar-expand-md bg-body py-3">
			<div class="container"><a class="navbar-brand d-flex align-items-center" href="#"
					style="padding-bottom: 0px;margin-top: 0px;padding-top: 0px;"><img src="assets/img/Untitled-1.png"
						style="width: 109px;"></a></div>
		...
		<div class="row d-flex d-xl-flex justify-content-center justify-content-xl-center"
			...
			<div class="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 reg" style="border-radius: 9px;background: #ffffffb0;">
				<div class="p-5">
					...
					<form class="user" action="include/signup.php" method="post"><!-- Start: Names -->
						<div class="row mb-3">
						...
						</div><button class="btn btn-primary d-block btn-user w-100 reg-btn" id="submitBtn" name="submit"
					...
					<div style="text-align: center;"><a class="forgot-password" href="#" style="font-size: 14px;"><span
								style="color: rgb(0, 0, 0);">Already have an account? Login</span></a></div>
				</div>
			</div>
		</div>
		<script>
